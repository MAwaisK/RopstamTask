      ...
      <SafeAreaView style={MainDashboardStyles.SafeAreaContainer}>
        <View style={[MainDashboardStyles.Container]}>
          <View style={[MainDashboardStyles.Header]}>
            ...
            <>
              <View style={MainDashboardStyles.HeaderContent}>
                <Text style={MainDashboardStyles.HeaderContentText}>
                  Dashboard{' '}
                </Text>
              </View>
            </>
          ...
          <View style={MainDashboardStyles.Body}>
            <View
              style={[
                MainDashboardStyles.CardContainer,
                Platform.OS === 'ios'
                  ? MainDashboardStyles.Card
                  : MainDashboardStyles.Card2,
              ]}>
              <ScrollView showsVerticalScrollIndicator={false}>
                <View style={MainDashboardStyles.InnerCardContainer}>
                  <TouchableOpacity
                    ...
                    style={[
                      Platform.OS === 'ios'
                        ? MainDashboardStyles.Card3
                        : MainDashboardStyles.Card4,
                      MainDashboardStyles.InnerCardLeftStyle,
                    ]}>
                  ...
                  <TouchableOpacity
                    ...
                    style={[
                      Platform.OS === 'ios'
                        ? MainDashboardStyles.Card3
                        : MainDashboardStyles.Card4,
                      MainDashboardStyles.InnerCardRightStyle,
                    ]}>
                    <View style={MainDashboardStyles.LogoContainer}>
